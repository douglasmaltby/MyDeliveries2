...
public class OnboardingFlowProvider: OnboardingFlowProviding {
    ...
    private func configuredWelcomeScreenStep() -> WelcomeScreenStep {
        let discoveryConfigurationTransformer = DiscoveryServiceConfigurationTransformer(applicationID: "com.dmaltby.SalesAssistant2", authenticationPath: "com.dmaltby.MyDeliveries2")
        let welcomeScreenStep = WelcomeScreenStep(transformer: discoveryConfigurationTransformer, providers: [DiscoveryServiceConfigurationProvider(applicationID: "com.dmaltby.SalesAssistant2")])

        welcomeScreenStep.welcomeScreenCustomizationHandler = { welcomeStepUI in
            welcomeStepUI.headlineLabel.text = "com.dmaltby.SalesAssistant2"
            ...
            if let welcomeScreen = welcomeStepUI as? FUIWelcomeScreen {
                ...
                welcomeScreen.emailTextField.text = "user@trial-s0003913080trial.sapmobileplace.com"
            }
        }
